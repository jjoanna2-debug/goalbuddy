...
When improving this repo, consider README, `goalbuddy/SKILL.md`, generated `$goal-maker` compatibility behavior, templates, checker behavior, CLI UX, plugin UX (both Codex and Claude Code), examples, package contents, local board behavior, and site/docs copy. Do not assume a request only touches code.
